      ...
      <div className="promo__container">
        <div className={s.row}>
          <div className={s.columnText}>
            <h1 className={s.title}>Производство уплотнителей в Минске и в других регионах Беларуси</h1>
            <p className={s.subTitle}>Изготовим любой уплотнитель по Вашим чертежам в срок от 5 дней</p>
